...
class Reports extends CI_Controller
{
  ...
  public function summary_report()
  {
    if (isset($_POST['submit'])) {
      ...
      $view_data['qa_summary'] = $this->main->get_summary_report($question);
      $view_data['question'] = $this->mcommon->records_all('polling_questions',array('status'=>1));
//       echo "<pre>";
// print_r($view_data['qa_summary']);

// EXIT();

    } else {    
      $view_data['question'] = $this->mcommon->records_all('polling_questions',array('status'=>1));
      $view_data['qa_summary'] = "";
    }
    $data = array(
