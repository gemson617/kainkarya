			...
			<div class="container-fluid">
				...
				<div id="navbar-menu">
					<ul class="nav navbar-nav navbar-right">
							...
							<li class="dropdown">
							<a href="#" ><span><?= "Financial Year:	 <b>".$cur_year.'</b>'; ?></span> </a>							
						</li> 
						<!-- <li class="dropdown">
				...
				<nav>
					<ul class="nav">
						...
						<li><a href="<?= base_url('home/register') ?>" class=""><i class="lnr lnr-user"></i> <span>User Registration</span></a></li>
						 <li>
							<a href="#subPages1" data-toggle="collapse" class="collapsed"><i class="lnr lnr-file-empty"></i> <span>Reports</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
						...
						<li>
							<a href="#subPages2" data-toggle="collapse" class="collapsed"><i class="lnr lnr-laptop-phone"></i> <span>Settings</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
						...
						<li>
							<a href="#subPages3" data-toggle="collapse" class="collapsed"><i class="lnr lnr-layers"></i> <span>Web Content</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
								<div id="subPages3" class="collapse ">
									<ul class="nav">
										<li><a href="<?= base_url('home/aboutUs') ?>" class=""><i class="lnr lnr-laptop-phone"></i> <span>AboutUs Management</span></a></li>
										<li><a href="<?= base_url('home/aid_upload') ?>" class=""><i class="lnr lnr-upload"></i> <span>Document Upload</span></a></li>
										<li><a href="<?= base_url('home/download') ?>" class=""><i class="lnr lnr-download"></i> <span>Download Management</span></a></li>
										<li><a href="<?= base_url('gallery/slider') ?>" class=""><i class="lnr lnr-layers"></i> <span>Slider Management</span></a></li>
										<li><a href="<?= base_url('gallery/gallery') ?>" class=""><i class="lnr lnr-picture"></i> <span> Photo Management </span></a></li>
										<li><a href="<?= base_url('gallery/gallery_album') ?>" ><i class="lnr lnr-picture"></i> <span> Photo Album </span></a></li>						
						...
						<li>
							<a href="#subPages4" data-toggle="collapse" class="collapsed"><i class="lnr lnr-list"></i> <span>Income Tax </span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
							<div id="subPages4" class="collapse ">
								<ul class="nav">
									<li><a href="<?= base_url('home/BD_report') ?>" class=""><i class="lnr lnr-layers"></i> <span>10 BD Report</span></a></li>
									<li><a href="<?= base_url('home/aid_pdf') ?>" class=""><i class="lnr lnr-upload"></i> <span>10 BE upload</span></a></li>
									<li><a href="<?= base_url('home/pdf_users') ?>" class=""><i class="lnr lnr-file-empty"></i> <span>View 10 BE Certificate</span></a></li>
									<li><a href="<?= base_url('home/be_summary') ?>" class=""><i class="lnr lnr-list"></i> <span>10 BE Summary</span></a></li>
								</ul>
							</div>
						</li> 		
						
									<?php
									 $years=$this->main->get_financial_year(); 
									 $i=1;
									 foreach($years as $row){
									?>
									<li><a href="<?= base_url('questionnaire/show/').$row['year'] ?>" class=""><i class="lnr lnr-layers"></i>Questionnaire</a></li>																	
									<?php $i++;} ?>
								
						
						
						<!-- <li><a href="<?= base_url('questionnaire') ?>" class=""><i class="lnr lnr-layers"></i> <span>Questionnaire</span></a></li> -->
						
						
						<!-- <li><a href="<?= base_url('polling/polling_list') ?>" class=""><i class="lnr lnr-layers"></i> <span>Questionnaire List</span></a></li> -->
						

						<!-- <li>
							<a href="#subPages" data-toggle="collapse" class="collapsed"><i class="lnr lnr-file-empty"></i> <span>Questionnaire</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
							<div id="subPages" class="collapse ">
								<ul class="nav">
									<li><a href="<?= base_url('polling') ?>" class="">Questionnaire</a></li>
									<li><a href="<?= base_url('polling/polling_list') ?>" class="">Questionnaire List</a></li>								
									<li><a href="<?= base_url('questionnaire') ?>" class="">SINGLE List</a></li>								
								</ul>
							</div>
						</li> -->
						<!-- <li>
							<a href="#reports" data-toggle="collapse" class="collapsed"><i class="lnr lnr-file-empty"></i> <span>Reports</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
							<div id="reports" class="collapse ">
								<ul class="nav">
								 <li><a href="<?= base_url('polling') ?>" class="">Questionnaire</a></li> 
									<li><a href="<?= base_url('reports/user_polling') ?>" class="">user Report</a></li>								
									<li><a href="<?= base_url('reports/summary_report') ?>" class="">Summary Report</a></li>								
								</ul>
							</div>
						</li> -->
