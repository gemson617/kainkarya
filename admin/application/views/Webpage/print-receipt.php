...
<body onload="window.print()">
	...
	<table cellpadding="5" cellspacing="0" border="1" rules="all" width="100%" style="font-size: 14px;border:1px solid #000080!important;">
		...
		<tr>
			<td colspan="4">
				<h3 align="center" style="text-decoration: underline;margin: 10px;">RECEIPT</h3>
		...
		<tr>
			...
			<td colspan="4" align="center"><?php $check_date = '2021-11-28';
					...
					<b style="color: #990000!important;">
					DONATIONS TO THIS TRUST ARE EXEMPTED u/s 80G OF THE INCOME TAX ACT
					<!-- DONATIONS FROM 29TH NOVEMBER 2021 ARE EXEMPTED u/s 80G OF THE INCOME TAX ACT -->
					</b>
				<?php } //} ?></td>
		</tr>
		<tr>
