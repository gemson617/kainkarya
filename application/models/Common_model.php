...
class Common_model extends CI_Model
{
    ...
    public function get_certification($id='',$year='')
    {
        $this->db->select('u.firstName,u.lastName,u.email,a.file_name,a.year');
        $this->db->from('users as u');
        $this->db->join('aid_file_pdf as a', 'a.userid=u.id');
    ...
    public function get_polling_by_id($user_auth_level,$polling_id)
    {
        $this->db->select("*");
