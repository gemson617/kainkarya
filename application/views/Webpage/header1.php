						...
						<ul class="navbar-nav">
							...
							<li class="dropdown show">
								...
								<div class="dropdown-menu show" style="display: none;">
									...
									<a class="dropdown-item" href="<?= base_url('OurInspiration') ?>">Our Inspiration</a>
									<a class="dropdown-item" href="<?= base_url('OurVision') ?>">Our Vision &amp; Mission</a>
									 <a class="dropdown-item" href="<?= base_url('OurMission') ?>">Our Mission</a>
									<a class="dropdown-item" href="<?= base_url('OurObjectives') ?>">Our Objectives</a>
									<a class="dropdown-item" href="<?= base_url('OurActivities') ?>">Our Activities</a>
								</div>
							</li>
